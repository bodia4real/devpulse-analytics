...
- Create project structure (backend/src with config, routes, controllers, middleware, types folders)
- Initialize Node.js project with TypeScript
- Install dependencies: express, pg, dotenv, cors, typescript, @types packages
...
- Create users table (id, github_id, username, email, avatar_url, access_token, timestamps)
- Create repos table (id, user_id, github_repo_id, name, full_name, description, language, stars, forks, open_issues, watchers, timestamps)
- Create contributions table (id, user_id, date, commit_count, pr_count, issue_count, timestamp)
- Add indexes for performance
- Create database connection pool in src/config/database.ts
